  ...
  // ────────────────────────────────────────────────────────────────────────────
  {
    ...
    prevention: {
      ...
      tools: [
        ...
        {
          name: "Report Scams: CICC",
          category: "Report",
          description: "File a cybercrime complaint at cicc.gov.ph/report — the central repository under DICT. Submit via online form; initial review takes ~8 days. CICC refers cases to PNP-ACG or NBI-CCD for investigation.",
          free: true,
        },
        {
          name: "Report Scams: PNP-ACG",
          category: "Report",
          description: "Report cybercrime to the PNP Anti-Cybercrime Group at pnp.gov.ph. Use the e-Sumbong online portal, call (02) 723-0401 local 7491, email acg@pnp.gov.ph, or visit ACG headquarters at Camp Crame, Quezon City.",
          free: true,
        },
        {
          name: "Report Scams: NBI-CCD",
          category: "Report",
          description: "Report to the NBI Cybercrime Division at nbi.gov.ph for complex or cross-border cybercrimes. Call (02) 8523-8231, email cybercrime@nbi.gov.ph, or visit the main office at Taft Avenue, Manila.",
          free: true,
        },
        {
          name: "Report Scams: DOJ-OOC",
          category: "Report",
          description: "The DOJ Office of Cybercrime (doj.gov.ph/office-of-cybercrime.html) oversees prosecution and international cooperation. Contact: (+632) 523-8482 or (+632) 523-6826.",
          free: true,
        },
      ],
